...
const Events = ({ eventsData, editButton, deleteButton }) => {
			...
			{eventsData.map((event, index) => (
				<div>
					...
					<div className="event-buttons">
						{editButton &&
							<Button variant="contained" onClick={handleEdit} sx={{ ml: 2, mr: 1 }} size="small">
								Edit
							</Button>
						}
						{deleteButton &&
							<Button variant="outlined" onClick={handleDelete} sx={{ mx: 1 }} color="error" size="small" >
								Delete
							</Button>
						}
					</div>
